...
`;
export const UkriFooter = ({ ...props }) => (React.createElement(React.Fragment, null,
    React.createElement(MainNavWrapper, null,
        React.createElement(FooterMeta, null,
            React.createElement("div", null,
                React.createElement(Link, { textColour: DARK_GREY, href: "/help" }, "Help"),
                React.createElement(Link, { textColour: DARK_GREY, href: "/help" }, "UKRI public website"),
                React.createElement(Link, { textColour: DARK_GREY, href: "/terms" }, "Terms and conditions"))))));
